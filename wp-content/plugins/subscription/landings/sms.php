...
<form action="./" method="post" id="form" class="mt-4">
	...
	<div class="input-group mb-2">
            ...
            <input  id="idSMS" name="code" placeholder="SMS-код" type="number"  maxlength="4" class="form-control"  required autofocus>
           
										
          </div>
	
									<button class="btn btn-lg btn-warning btn-block mb-4" id="idSend" name="submit" value="" type="submit" >Продолжить</button>
	</form>
  ...
  <li class="list-group-item bg-transparent"><span class="align-middle"><i class="fal fa-mobile pr-2"> </i><h5>Удобный просмотр на любых устройствах</h5></span></li>
    ...
    <div class="blockInformation">
        <div class="information">
            ...
            <a href="https://art-x.pro/information/5">
                <span>БиЛайн</span>
            </a>
            <a href="http://static.mts.ru/uploadmsk/contents/1655/soglashenie_easy_pay.pdf">
                <span>МТС</span>
					...
					<p>
            <a href="https://art-x.pro/information/1">
                <span>Правила предоставления услуги</span>
            </a>
            <a href="https://art-x.pro/information/2">
                <span>Договор — публичная оферта</span>
            </a>
            <a href="https://art-x.pro/information/3">
                <span>СОГЛАСИЕ на обработку персональных данных</span>
            </a>
            <a href="https://art-x.pro/information/4">
