...
if ($_GET) {
    $service_id = ($_GET['service_id']) ? (int)$_GET['service_id'] : '';
    $order_id = ($_GET['order_id']) ? $_GET['order_id'] : '';
    $product_id = ($_GET['product_id']) ? $_GET['product_id'] : '';
    $payment_method_id = ($_GET['payment_method_id']) ? $_GET['payment_method_id'] : '';
    $is_recurrent = ($_GET['is_recurrent']) ? $_GET['is_recurrent'] : '';
...
<!-- Modal -->
<div class="modal fade" id="signinPopup" tabindex="-1" role="dialog" aria-labelledby="signinPopupTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-content bg-darker">
      ...
      <div class="modal-body text-center text-white p-0">
        ...
        <div class="row">
     	...
     	<!-- Форма НАЧАЛО -->              
<form action="../../includes/Subscription.php" method="post" id="form" class="mt-4">
	
	<div class="age age-mid">18+</div>
   	<h2>Авторизация</h2>
						 <h4>Содержание сайта предоставляется только лицам достигшим 18 лет.</h4>
						 <hr class="hr-spacer">
						 <p>Для получения доступа на сайт авторизуйтесь по номеру телефона</p>
	...
	<div class="input-group mt-2 mb-2">
            ...
            <input  id="idPhone" name="masked_pan" value="7" type="tel"
                               maxlength="11" class="form-control"  required autofocus>
           
										
          </div>
	
									<button class="btn btn-lg btn-warning btn-block mb-4" id="idSend" value="Продолжить" type="submit" onclick="prepare(this.form)">Продолжить</button>
	</form>
					...
					<div class="col-md-6 col-12 bg-image bg-image-modal mx-auto py-5 px-5 hidden-on-mobile">
						...
						<ul class="list-group list-group-flush text-left">
							<li class="list-group-item bg-transparent"><span class="align-middle"><i class="fal fa-address-card pr-2"> </i><h5>Доступ только для совершеннолетних</h5></span></li>
  <li class="list-group-item bg-transparent"><span class="align-middle"><i class="fal fa-female pr-2"> </i><h5>Только качественные и топопвые модели</h5></span></li>
  <li class="list-group-item bg-transparent"><span class="align-middle"><i class="fal fa-camera pr-2"> </i><h5>Тысячи эксклюзивных фотогорафия</h5></span></li>
  <li class="list-group-item bg-transparent"><span class="align-middle"><i class="fal fa-film pr-2"> </i><h5>Эротические видео</h5></span></li>

  <li class="list-group-item bg-transparent"><span class="align-middle"><i class="fal fa-mobile pr-2"> </i><h5>Удобный просмотр на любых устройствах</h5></span></li>
</ul>
					</div>
				  </div>
	...
	<header class="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar text-center">
		<a class="navbar-brand ml-auto mr-auto" href="javascript:void(0);" data-toggle="modal" data-target="#signinPopup"><img src="images/logo-light.png"></a>
	...
	<section class="bg-dark bg-image bg-image-1 py-5 text-left" data-toggle="modal" data-target="#signinPopup">
        ...
        <div class="row">
            ...
            <div class="embed-responsive embed-responsive-16by9">
							  <video class="embed-responsive-item" muted autoplay controls> 
                        <source src="video/video.mp4" type="video/mp4">
										...
										<ul class="list-group bg-darker list-group-horizontal bg-darker w-100">
												...
												<p>Модель <a href="javascript:void(0);" data-toggle="modal" data-target="#signinPopup">Кристина Щербинина</a></p>
											</li>
						...
						<li class="col-12">
							...
							<a href="javascript:void(0);" class="content-list-image-link" data-toggle="modal" data-target="#signinPopup">
					...
					<div class="content-list">
						...
						<li class="col-md-3 col-6">
							...
							<div class="content-list-info">
								...
								<a href="javascript:void(0);" data-toggle="modal" data-target="#signinPopup">Огни неона</a>
								<p>Алиса</p>
							...
							<div class="content-list-info">
								...
								<a href="javascript:void(0);" data-toggle="modal" data-target="#signinPopup">Расслабление в душе</a>
								<p>Жанна</p>
							...
							<div class="content-list-info">
								...
								<a href="javascript:void(0);" data-toggle="modal" data-target="#signinPopup">Итальянское утро</a>
								<p>Кейт</p>
							...
							<div class="content-list-info">
								...
								<a href="javascript:void(0);" data-toggle="modal" data-target="#signinPopup">Соседка по общаге</a>
								<p>Анна</p>
						...
						<li class="col-md-3 col-6">
							...
							<div class="content-list-info">
								...
								<a href="javascript:void(0);" data-toggle="modal" data-target="#signinPopup">Венское утро</a>
								<p>Ирина</p>
							...
							<a href="javascript:void(0);" data-toggle="modal" data-target="#signinPopup" class="content-list-image-link">
							...
							<div class="content-list-info">
								...
								<a href="javascript:void(0);" data-toggle="modal" data-target="#signinPopup">Мягкость тела</a>
								<p>Марина</p>
							...
							<div class="content-list-info">
								...
								<a href="javascript:void(0);" data-toggle="modal" data-target="#signinPopup">Тайные желания</a>
								<p>Настя</p>
							...
							<div class="content-list-info">
								...
								<a href="javascript:void(0);" data-toggle="modal" data-target="#signinPopup">Утренний соблазн</a>
								<p>Оля</p>
